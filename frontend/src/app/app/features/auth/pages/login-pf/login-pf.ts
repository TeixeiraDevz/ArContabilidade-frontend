...
@Component({
  ...
  standalone: true,
  imports: [RouterLink],
  templateUrl: './login-pf.html',
  styles: [`
    :host {
      display: block;
      min-height: 100vh;
      background: radial-gradient(circle at top left, rgba(102, 126, 234, 0.15), transparent 45%), var(--color-gray-light);
      padding: 6rem 0 4rem;
    }

    .login-section .badge-soft {
      display: inline-flex;
      align-items: center;
      gap: 0.5rem;
      padding: 0.5rem 1rem;
    ...
    .btn-primary:hover {
      ...
      box-shadow: 0 22px 40px rgba(118, 75, 162, 0.35);
    }
